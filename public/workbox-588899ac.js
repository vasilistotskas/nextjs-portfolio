define(['exports'], function (t) {
	...
	function T(t) {
		return 'function' == typeof t
			...
			: (t instanceof IDBTransaction &&
			  ...
			  (e = t),
			  (
					D || (D = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
	...
	function j(t, e) {
		...
		const i = async function (t, ...e) {
			...
			let a = i.store
			return (
				n && (a = a.index(e.shift())), (await Promise.all([a[s](...e), r && i.done]))[0]
			)
		}
		return W.set(e, i), i
	}
	...
	class Y extends R {
		...
		async D(t, e) {
			...
			return (
				s ||
				(e.event && 'install' === e.event.type ? await this.j(t, e) : await this.S(t, e))
			)
		}
		async S(t, e) {
			let n
