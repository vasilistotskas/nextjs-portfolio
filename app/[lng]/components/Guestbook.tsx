...
import SuccessMessage from '@app/[lng]/components/utils/SuccessMessage'
import ErrorMessage from '@app/[lng]/components/utils/ErrorMessage'
...
export default async function Guestbook({ fallbackData }) {
	const { t } = useTranslation('en', ['common', 'guestbook'])
